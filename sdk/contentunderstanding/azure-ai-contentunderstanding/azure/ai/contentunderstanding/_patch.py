...
class ContentUnderstandingClient(GeneratedClient):
    ...
    def get_analyze_result(
        ...
        :attr:`~azure.ai.contentunderstanding.models.AnalyzeLROPoller.operation_id`), then call
        this method from any worker to fetch the current status and, once available, the result.
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._get_result(operation_id, **kwargs)
